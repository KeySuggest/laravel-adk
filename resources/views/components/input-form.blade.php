<form onsubmit="Alpine.store('loading').open = true;" method="GET" action="/">
  <div class="flex w-full flex-col lg:flex-row transition duration-150 ease-in-out space-y-2 lg:space-y-0 lg:space-x-2">
    <input type="text" name="input" class="form-input lg:w-104 w-full flex-grow" placeholder="Enter Keyword" required />
    <select name="platform" class="form-select lg:w-32 w-full" required>
      <option value="google">Google</option>
      <option value="youtube">YouTube</option>
      <option value="amazon">Amazon</option>
    </select>
    <select name="lang" class="form-select lg:w-32 w-full" required>
      ...
      <option value="1072">Gujarati</option>
      ...
      <option value="1086">Kannada</option>
      ...
      <option value="1098">Malayalam</option>
      <option value="1101">Marathi</option>
    ...
    <select name="geo" class="form-select lg:w-32 w-full" required>
      <option value="0">Globe</option>
      ...
      <option value="2239">South Georgia</option>
      ...
      <option value="2260">French Southern</option>
      ...
      <option value="2581">Minor Outlying Islands</option>
      ...
      <option value="2736">Sudan</option>
    ...
    <div class="rounded-md flex items-center justify-center px-8 py-3 text-base font-medium leading-6 text-white border border-transparent rounded-md bg-wave-500 hover:bg-wave-600 focus:outline-none focus:border-wave-600 focus:shadow-outline-indigo md:py-4 md:text-lg md:px-10">
      <input type="submit" value="Search" />
    </div>

  </div>
  @if($errors->any())
  {!! implode('', $errors->all('<span class="text-red-500 text-sm">:message</span></br>')) !!}
  @endif
</form>
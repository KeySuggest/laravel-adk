...
<footer class="@if(Request::is('/')){{ 'bg-white' }}@else{{ 'bg-gray-50' }}@endif">
    <div class="px-8 pt-16 mx-auto lg:px-12 xl:px-16 max-w-7xl">
        <div class="flex flex-wrap items-start justify-between pb-20">
            <a href="https://keysuggest.io" class="flex items-center w-auto text-lg font-bold md:w-1/6">
                <img class="h-10" src="https://keysuggest.io/logo.png" alt="KeySuggest">
            </a>
            <div class="grid w-full grid-cols-2 pt-2 mt-20 sm:grid-cols-4 gap-y-16 lg:gap-x-8 md:w-5/6 md:mt-0 md:pr-6">
                <div class="md:justify-self-end">
                    ...
                    <ul class="mt-6 space-y-4 text-sm">
                        ...
                        <li>
                            <a href="https://keysuggest.io/marketplace" class="relative inline-block text-black group">
                                <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-black opacity-0 group-hover:opacity-100 group-hover:translate-y-1"></span>
                                <span>Addons</span>
                            </a>
                        </li>
                        <li>
                            <a href="https://keysuggest.document360.io/" target="_blank" class="relative inline-block text-black group">
                                <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-black opacity-0 group-hover:opacity-100 group-hover:translate-y-1"></span>
                                <span>Help Center</span>
                            </a>
                        </li>
                        <li>
                            <a href="https://keysuggest.io/pricing" class="relative inline-block text-black group">
                                <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-black opacity-0 group-hover:opacity-100 group-hover:translate-y-1"></span>
                                <span>Pricing</span>
                            </a>
                        </li>
                ...
                <div class="md:justify-self-end">
                    ...
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
                            <a href="https://keysuggest.document360.io/docs/api" target="_blank" class="relative inline-block text-black group">
                                <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-black opacity-0 group-hover:opacity-100 group-hover:translate-y-1"></span>
                                <span>API Documentation</span>
                            </a>
                        </li>
                        <li>
                            <a href="https://keysuggest.io/blog" class="relative inline-block text-black group">
                                <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-black opacity-0 group-hover:opacity-100 group-hover:translate-y-1"></span>
                                <span>Our Blog</span>
                            </a>
                        </li>
                        <li>
                            <a href="https://status.keysuggest.io/" class="relative inline-block text-black group">
                                <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-black opacity-0 group-hover:opacity-100 group-hover:translate-y-1"></span>
                                <span>Status</span>
                            </a>
                        </li>
        ...
        <div class="flex flex-col items-center justify-between py-10 border-t border-solid lg:flex-row border-gray">
            ...
            <ul class="flex items-center mt-10 space-x-5 lg:mt-0">
                <li>
                    <a href="https://www.facebook.com/keysuggest" target="_blank" class="text-gray-600 hover:text-gray-900">
                ...
                <li>
                    <a href="https://www.instagram.com/keysuggest/" target="_blank" class="text-gray-600 hover:text-gray-900">
                ...
                <li>
                    <a href="https://twitter.com/keysuggest/" target="_blank" class="text-gray-600 hover:text-gray-900">
                ...
                <li>
                    <a href="https://github.com/keysuggest/" target="_blank" class="text-gray-600 hover:text-gray-900">
